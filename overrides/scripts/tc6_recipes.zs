...
ArcaneWorkbench.registerShapedRecipe("ArcaneLamp", "ARCANELAMP", 125,
    ...
    [<ore:paneGlass>, <minecraft:daylight_detector>, <ore:paneGlass>],
    [<ore:plateSteel>, <ore:blockAmber>, <ore:plateSteel>],[<ore:paneGlass>, <ore:nitor>, <ore:paneGlass>]
    ]);
...
ArcaneWorkbench.registerShapedRecipe("bellows", "BELLOWS", 100,
    ...
    [<backpack:tanned_leather>, <gregtech:meta_item_1:172>, <backpack:tanned_leather>],[<thaumcraft:slab_greatwood>, <thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aer"}]}), <thaumcraft:slab_greatwood>]
    ]);
...
ArcaneWorkbench.registerShapedRecipe("AutomatedCrossbow", "BASICTURRET", 100,
    ...
    [<ore:plateSteel>, <mujmajnkraftsbettersurvival:itemcrossbow>, <ore:plateSteel>],
    [<thaumcraft:plank_greatwood>, <thaumcraft:mechanism_simple>, <thaumcraft:plank_greatwood>],
    [<ore:stickSteel>, <thaumcraft:mind>, <ore:stickSteel>]
    ]);
...
ArcaneWorkbench.registerShapedRecipe("RECHARGEPEDESTAL", "RECHARGEPEDESTAL", 200,
    ...
    [<thaumcraft:salis_mundus>, <ore:plateGold>, <thaumcraft:salis_mundus>],
    [<ore:gemFlawlessDiamond>, <thaumcraft:pedestal_arcane>, <ore:gemFlawlessDiamond>],
...
ArcaneWorkbench.registerShapedRecipe("FocusPouch", "FOCUSPOUCH", 50,
    [], <thaumcraft:focus_pouch>, [
    [<ore:boltBrass>, <ore:ringBrass>, <ore:boltBrass>],
    [<harvestcraft:hardenedleatheritem>, <thaumcraft:baubles:2>, <harvestcraft:hardenedleatheritem>],
...
Infusion.registerRecipe("mirrorhand", "MIRRORHAND", <thaumcraft:hand_mirror>, 7.5,
    ...
    [<ore:stickTreatedWood>, <ore:paperMap>, <thaumicwonders:structure_diviner>, <ore:gemFlawlessAmber>]);
...
Infusion.registerRecipe("causalityCollapser", "RIFTCLOSER", <thaumcraft:causality_collapser>, 15,
    ...
    [<ore:nitor>, <thaumcraft:vis_resonator>, <ore:blockRedstone>, <thaumcraft:morphic_resonator>, <thaumcraft:alumentum>, <ore:nitor>, <thaumcraft:vis_resonator>, <ore:blockRedstone>, <thaumcraft:morphic_resonator>, <thaumcraft:alumentum>]);
