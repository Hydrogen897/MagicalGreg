...
ArcaneWorkbench.registerShapedRecipe("gauntlet_thaumium", "GAUNTLET_THAUMIUM", 300,
    ...
    [<keletupack:packresource:4>, <ore:plateThaumium>, <ore:lensSapphire>],
    [<ore:plateThaumium>, <thaumcraft:caster_basic>, <ore:plateThaumium>],
    [<ore:ringThaumium>, <ore:plateThaumium>, <keletupack:packresource:4>]
    ]);
...
Infusion.registerRecipe("GAUNTLET_VOID", "GAUNTLET_VOID@1", <thaumicaugmentation:gauntlet:1>.withTag({color: 2498903}), 6,
    ...
    [<thaumcraft:salis_mundus>, <ore:itemEnchantedFabric>, <keletupack:packresource:5>, <ore:plateVoid>, <ore:plateVoid>, <thaumcraft:voidseer_charm>, <ore:plateVoid>, <ore:plateVoid>, <keletupack:packresource:5>, <ore:itemEnchantedFabric>, <thaumcraft:salis_mundus>, <gregtech:meta_item_1:218>]);
...
Infusion.registerRecipe("thaumiumrobes1", "THAUMIUM_ROBES", <thaumicaugmentation:thaumium_robes_hood>.withTag({color: 11360678}), 2,
    ...
    [<harvestcraft:hardenedleatheritem>, <ore:itemEnchantedFabric>, <thaumcraft:salis_mundus>, <ore:itemEnchantedFabric>, <ore:plateThaumium>, <ore:itemEnchantedFabric>, <ore:plateThaumium>, <ore:itemEnchantedFabric>, <thaumcraft:salis_mundus>, <ore:itemEnchantedFabric>]);
...
Infusion.registerRecipe("thaumostatic_harness", "THAUMOSTATIC_HARNESS", <thaumicaugmentation:thaumostatic_harness>, 7.5,
    ...
    [<thaumcraft:levitator>, <gregtech:meta_item_1:128>, <thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aer"}]}), <gregtech:meta_item_1:502>, <ore:plateBrass>, <thaumcraft:morphic_resonator>, <ore:plateBrass>, <gregtech:meta_item_1:502>, <thaumcraft:crystal_essence>.withTag({Aspects: [{amount: 1, key: "aer"}]}), <gregtech:meta_item_1:128>]);
...
Infusion.registerRecipe("rift_power", "RIFT_POWER", <thaumicaugmentation:material:3>, 7.6,
    ...
    [<keletupack:packresource:4>, <gregtech:meta_item_1:234>, <ore:screwVoid>, <keletupack:packresource:4>, <ore:gemExquisiteAmber>, <ore:screwVoid>, <gregtech:meta_item_1:219>, <keletupack:packresource:4>, <gregtech:meta_item_1:219>, <ore:screwVoid>, <keletupack:packresource:4>, <ore:blockRedAlloy>, <ore:screwVoid>, <gregtech:meta_item_1:234>]);
