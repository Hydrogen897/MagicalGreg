...
.components([
    ...
    .flags(["generate_plate", "generate_bolt_screw","generate_rod", "generate_rotor", "generate_small_gear","generate_ring","generate_frame"])
    .build();
...
<material:brass>.addFlags("generate_ring", "generate_bolt_screw");
